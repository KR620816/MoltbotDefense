...
import { Blockchain, BlockPattern } from './chain';
...
describe('Blockchain', () => {
    ...
    it('should reject invalid previous hash', () => {
        ...
        // createBlock uses the provided prevHash to calculate hash.
        // validation checks if newBlock.previousHash === latest.hash
    ...
    it('should modify chain validity check', () => {
        ...
        // Now recalculate hash? No, if we just modify data, hash becomes invalid 
        // relative to content. But `isChainValid` checks `calculateHash() === block.hash`.
